...
% If name isn't empty print response
% if ~isempty(name)
  % Print response %s inserts the string into output
  % fprintf("Hello %s\n", name);
% end

% vInput = input("Enter a Vector : "); % [2 3 4]
% disp(vInput);
